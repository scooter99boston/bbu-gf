...
6. Once approved, information about the new or revised Bedrock Consortium Governing Body MUST be added to:
		...
		1. The Bedrock Consortium Governing Bodies Controlled Document, including all the information required therein.
		1. The Bedrock Consortium Foundation website.
...
3. A council:
		...
		1. MUST have at least one chairperson appointed by the Bedrock Consortium Governing Board who, if not already a Trustee, shall serve as an ex-officio Trustee unless an exception is made by the BoD.
		1. MAY limit the total number of voting members.
		1. MAY establish membership term limits.

4. A committee:

		1. SHOULD have a Trustee serving as at least one of its chairperson(s).		
		1. MAY limit the total number of voting members.
		1. MAY establish membership term limits.

5. A working group:

		1. MUST be open to participation by any member of the Bedrock Consortium Community.
		1. MUST NOT establish membership term limits.

## 3. Chairpersons
1. A chairperson of a Bedrock Consortium Governing Body:

		1. MUST be a member of that Bedrock Consortium Governing Body.		
		1. MUST NOT be an employee of the Bedrock Consortium Foundation unless an exception is made by the BoD.
...
2. A Bedrock Consortium Governing Body MAY appoint the following types of subgroups as needed to accomplish its mission:
		...
		1. Team — an ongoing subgroup organized around a focus area.
		1. Task Force — a short-term subgroup organized to accomplish a specified task within a specified time period.
...
1. In keeping with the Transparency Principle ( Bedrock Consortium V2 Master Document section 2.6), Bedrock Consortium Governing Bodies:
		...
		1. MUST conduct open, transparent meetings with the exception of special closed sessions.		
		1. MUST only conduct special closed sessions (not open to the public) when the group needs to deal with matters where confidentiality is required due to:
		...
		1. SHOULD conduct meetings that allow virtual participation whenever possible.
...
3. The meeting page MUST include:
		...
		1. All information about the group listed in Bedrock Consortium Governing Bodies , including a link to the current charter.
		1. A list of the current chairperson(s).
		1. A list of the current facilitator(s).
		1. A list of current active members.
		1. Information about how to join the group.		
		1. Information about any organized subgroups, including:
		...
		1. A schedule of open public meetings.
    1. Information about how to participate in open public meetings (physical or virtual).
    1. Information about how to participate in open public chat channels (e.g.,
    Rocketchat).
    1. Agendas and meeting minutes/notes listed in reverse chronological order.		
    1. Links to any archived versions of the meeting page.
...
1. All Bedrock Consortium Governing Bodies:
		...
		1. SHOULD designate a member to attend and give a monthly report to the Bedrock Consortium BoD.
		1. MUST submit a monthly summary report of activity to the Bedrock Consortium Governing Board via either:
		...
		1. SHOULD send the same monthly report to the Steward mailing list.
